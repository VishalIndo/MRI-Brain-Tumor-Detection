...
### Evaluation Output Screenshot

Add your evaluation or confusion matrix screenshot below:
...
Add your sample prediction output below:
...
Add your Gradio interface screenshot below:
...
### Full Example Section for README

You can paste this full block directly:

```markdown
## Results and Output Screenshots

### 1. Training Output
This screenshot shows the model training process or final training logs.

![Training Output](images/training_output.png)

### 2. Evaluation Output
This screenshot shows the evaluation result such as accuracy, confusion matrix, or other metrics.

![Evaluation Output](images/evaluation_output.png)

### 3. Inference Output
This screenshot shows the model prediction on a sample MRI input.

![Inference Output](images/inference_output.png)

### 4. Gradio App
This screenshot shows the working Gradio user interface of the project.
...
## Example README Results Section With Text

Below is a longer written version you can also use:

```markdown
## Results

The project was tested on MRI data using the modular pipeline created from the original notebook.  
The training, evaluation, and inference stages were separated into different Python files for better code organization and easier maintenance.

The screenshots below show example outputs from different stages of the project.

### Training Output
The following image shows the training-related output of the model, such as logs, epoch progress, or loss values.

![Training Output](images/training_output.png)

### Evaluation Output
The following image shows the evaluation output of the trained model. This may include performance metrics, a confusion matrix, or validation results.

![Evaluation Output](images/evaluation_output.png)

### Inference Output
The following image shows a sample prediction generated by the trained model on MRI data.

![Inference Output](images/inference_output.png)

### Gradio Interface
The following image shows the Gradio web application used to test the model interactively.
